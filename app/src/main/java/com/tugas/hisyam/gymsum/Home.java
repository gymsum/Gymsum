...
public class Home extends AppCompatActivity {
    ...
    public void bJadwal(View view) {
        startActivity(new Intent(Home.this, InputJadwal.class));
    }
    ...
    public void bGym(View view) {
        startActivity(new Intent(Home.this, InfoGym.class));
    }
